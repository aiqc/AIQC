...
.. raw:: html
  ...
  <table class="compatibility qc" valign="center">
    ...
    <tr>
      <td class="top-left alt-gray">Prevent <b><i>evaluation bias</i></b> with 3-way+ stratification.</td>
      <td class="alt-gray">Split</br>or</br>Folds</td>
      <td class="alt-gray">Split</br>or</br>Folds</td>
      <td class="alt-gray">Holdout</br>split</td>
      <td class="best-practice"><b><i>Verify the schema</i></b> of incoming samples.</td>
    </tr>
    
    <tr>
      <td class="alt-darkerGray">Prevent <b><i>data leakage</i></b> with </br>fit-on-train preprocessing.</td>
      <td class="alt-darkerGray"><i>fit()</i>’s</br>&</br><i>transform()</i>’s</td>
      <td class="alt-darkerGray">Apply</br><i>transform()</i>’s</td>
      <td class="alt-darkerGray">Apply</br><i>transform()</i>’s</td>
      <td class="best-practice alt-darkerGray">Help prevent <b><i>data drift</i></b> </br>by using original preprocessors.</td>
    </tr>

    <tr>
      <td class="alt-gray">Detect <b><i>overfitting</i></b> by evaluating each split/ fold of every model.</td>
      <td class="alt-gray">Metrics</br>&</br>charts</td>
      <td class="alt-gray">Metrics</br>&</br>charts</td>
      <td class="alt-gray">Metrics</br>&</br>charts</td>
      <td class="alt-gray">Detect <b><i>model rot</i></b> by reevaluating with supervised datasets.</td>
    </tr>

    <tr>
      <td class="bottom-left alt-darkerGray">Ensure <b><i>reproducibility</i></b> by recording the entire workflow.</td>
...
.. raw:: html
  ...
  <center>
    ...
    <div class="blockz-container" style="width:41%;margin-top:16px;">
