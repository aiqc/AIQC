...
.. raw:: html
  ...
  <div style="background-image: linear-gradient(#24435f, #122536); height:80px; border-top-left-radius:25px; border-top-right-radius:25px; height: 95%;">
    ...
    <center>
      <div class="headerz titlez headerz-dark" style="font-family:Abel !important; font-size:25px !important">
        <span class="goldz-dark">Accelerate Research</span> with Deep Learning
      </div>
    </center>
  </div>
  ...
  <center>
    <div class="headerz-light" style="color:#828282; font-family:Abel !important; font-size:22px !important; line-height:180% !important; margin-left:30%; margin-right:30%;">
...
.. raw:: html
  ...
  <center>
    <div class="headerz-light">Write <span class="goldz-light">90% less glue-code</span> with <a class="linx-light" href='pages/gallery.html' style="text-decoration: underline;">declarative pipelines</a></div>
  </center>
  </br></br>
