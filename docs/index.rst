...
.. raw:: html
  ...
  <tr>
    <td id="top-left"></td>
    <td class="tbl-head  tbl-head-Tabular">Tabular</br><small>(array, df, file)</small></td>
    <td class="tbl-head  tbl-head">Sequence</br><small>(3D, files, time series)</small></td>
    <td class="tbl-head  tbl-head-Image">Image</br><small>(png, jpg)</small></td>
  </tr>
  <tr>
    <td class="tbl-head tbl-head-Classification">Classification</br><small>(binary, multi)</small></td>
    <td class="done">
